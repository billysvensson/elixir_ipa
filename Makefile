...
ifeq ($(CROSSCOMPILE),)
    ...
    ifneq ($(shell uname -s),Linux)
        $(error Elixir IPA only works on Linux. Crosscompiling is possible if $$CROSSCOMPILE is set.)
    endif
endif
...
priv/ipa: src/ipa_main.o src/gpio_port.o src/i2c_port.o src/spi_port.o src/erlcmd.o
	@mkdir -p priv
